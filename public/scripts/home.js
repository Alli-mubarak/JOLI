...
function viewPostMenu(e){
  ...
  ${currentUserId !== authorId? `<button id="add-friend-btn"><i class="fa-solid fa-user-plus"></i>Add <b>${authorUsername}</b> as friend</button>` : ""}
   ${currentUserId !== authorId? `<button id="view-user-btn"><i class="fa-solid fa-user"></i>View <b>${authorUsername}</b>'s profile</button>` : ""}
